# 1 "D:\\yolov5s_conv\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:\\yolov5s_conv\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "D:\\yolov5s_conv\\platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "D:\\yolov5s_conv\\platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "D:\\yolov5s_conv\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "D:\\yolov5s_conv\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  conv2d_layer_0: conv2d_layer@40000000 {
   compatible = "xlnx,conv2d-layer-1.0";
   xlnx,ii = "x";
   xlnx,machine = <64>;
   xlnx,s-axi-control-addr-width = <6>;
   xlnx,ip-name = "conv2d_layer";
   ...
   xlnx,latency = "undef";
   xlnx,name = "conv2d_layer_0";
  };
 };
};
# 4 "D:\\yolov5s_conv\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "D:\\yolov5s_conv\\platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
 ...
 &amba {
  processing_system7_0: processing_system7@0 {
   ...
   xlnx,pcw-act-fpga1-peripheral-freqmhz = <200>;
   ...
   xlnx,pcw-package-ddr-dqs-to-clk-delay-0 = <0xffffe4a8>;
   xlnx,pcw-uiparam-ddr-dqs-3-length-mm = <0>;
   xlnx,pcw-package-ddr-dqs-to-clk-delay-1 = <0xffffd8f0>;
   ...
   xlnx,pcw-package-ddr-dqs-to-clk-delay-3 = <0xffff4480>;
   xlnx,pcw-en-spi0 = <0>;
   xlnx,pcw-en-spi1 = <0>;
   ...
   xlnx,pcw-fclk1-peripheral-divisor0 = <4>;
...
# 5 "D:\\yolov5s_conv\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7z020";
 slrcount = <1>;
 family = "Zynq";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x40000000 &conv2d_layer_0 0x40000000 0x10000>,
