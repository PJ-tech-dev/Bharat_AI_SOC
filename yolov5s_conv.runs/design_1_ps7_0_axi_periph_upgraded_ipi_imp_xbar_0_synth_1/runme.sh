...
HD_PWD='D:/yolov5s_conv/yolov5s_conv.runs/design_1_ps7_0_axi_periph_upgraded_ipi_imp_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ps7_0_axi_periph_upgraded_ipi_imp_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ps7_0_axi_periph_upgraded_ipi_imp_xbar_0.tcl
