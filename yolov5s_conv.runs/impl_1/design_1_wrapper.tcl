namespace eval ::optrace {
  variable script "D:/yolov5s_conv/yolov5s_conv.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/yolov5s_conv/yolov5s_conv.cache/wt [current_project]
  set_property parent.project_path D:/yolov5s_conv/yolov5s_conv.xpr [current_project]
  set_property ip_repo_paths D:/yolov5s_conv/export [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/yolov5s_conv/yolov5s_conv.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/yolov5s_conv/yolov5s_conv.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/yolov5s_conv/yolov5s_conv.srcs/sources_1/bd/design_1/design_1.bd
